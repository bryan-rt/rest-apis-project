...
def create_app(db_url=None):
    ...
    app.config["SQLALCHEMY_DATABASE_URI"] = db_url or os.getenv("DATABASE_URL", "sqlite:///data.db") # connect to SQLite database, provide UI, PWD, etc. if needed
    ...
    # secrets.SystemRandom().getrandbits(128) # generate a random secret key
